...
const PLAYER_CHARACTER_ASSETS = {
  cat: {
    ...
    characterId: "mimi",
    idle: ["./assets/characters/mimi/v6/idle.png"],
    walk: [
    ...
    jump: ["./assets/characters/mimi/v6/jump.png"],
    happy: ["./assets/characters/mimi/v6/happy.png"],
    sit: [],
    thinking: [],
    holdDiary: [],
  },
  owl: {
    ...
    characterId: "owlly",
    idle: ["./assets/characters/owlly/v6/idle.png"],
    walk: [
      "./assets/characters/owlly/v6/fly_1.png",
      "./assets/characters/owlly/v6/fly_2.png",
      "./assets/characters/owlly/v6/fly_3.png",
    ],
    jump: ["./assets/characters/owlly/v6/fly_2.png"],
    write: ["./assets/characters/owlly/v6/write.png"],
    happy: ["./assets/characters/owlly/v6/happy.png"],
    nod: [],
    thinking: [],
    turnAround: [],
    wink: [],
...
const CHARACTER_REGISTRY = {
  mimi: {
    ...
    role: "player",
    species: "white_cat",
    asset: "./assets/characters/mimi/v6/idle.png",
    image: mappedImage("./assets/characters/mimi/v6/idle.png"),
  },
  owlly: {
    id: "owlly",
    name: "Owlly",
    ...
    role: "companion",
    species: "owl",
    asset: "./assets/characters/owlly/v6/idle.png",
    image: mappedImage("./assets/characters/owlly/v6/idle.png"),
  },
  blackBear: {
    id: "blackBear",
    name: "Black Bear",
