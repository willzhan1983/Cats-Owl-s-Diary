...
const levels = [
  ...
  },
  {
    ...
    tasks: [
      ...
      roadClearTask(294, 348, "落叶堆", "leafPile", "正在清理落叶……", 1.1),
      roadClearTask(390, 416, "小石块", "roadStone", "正在搬开小石块……", 1),
      roadClearTask(462, 310, "树枝堆", "branchPile", "正在清理树枝……", 0.9),
      roadClearTask(544, 392, "落叶堆", "leafPile", "正在清理落叶……", 1.1),
      roadClearTask(624, 302, "小石块", "roadStone", "正在搬开小石块……", 1),
      roadClearTask(688, 392, "树枝堆", "branchPile", "正在清理树枝……", 0.9),
      roadClearTask(742, 264, "落叶堆", "leafPile", "正在清理落叶……", 1.1),
      roadClearTask(784, 350, "小石块", "roadStone", "正在搬开小石块……", 1),
      roadClearTask(828, 252, "落叶堆", "leafPile", "正在清理落叶……", 1.1),
      roadClearTask(858, 332, "树枝堆", "branchPile", "正在清理树枝……", 0.9),
      roadClearTask(882, 406, "小石块", "roadStone", "正在搬开小石块……", 1),
    ],
    puddles: [],
    obstacles: [],
  },
