...
assert.match(index, /<script src="\.\/game\.js\?v=riverside-dock-difficulty-20260822"><\/script>/);
assert.match(index, /<script src="\.\/art-assets\.js\?v=acorn-town-20260729"><\/script>/);
