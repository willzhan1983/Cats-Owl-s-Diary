...
(function setupForestRoadQuizBank() {
  ...
  const forestRoadQuestions = [
    ...
    { difficulty: "hard", title: "森林公路挑战题", question: "道路上有 4 堆树枝、3 堆落叶和 5 组石块，一共有多少处要清理？", options: ["10", "11", "12", "13"], answer: 2 },
    ...
    { difficulty: "crazy", title: "森林公路综合挑战", question: "有 12 个障碍，已经清理了 5 个。再清理几个才能全部完成？", options: ["5", "6", "7", "8"], answer: 2 },
  ...
  const placements = [
    { level: "森林公路入口", x: 836, y: 188, name: "清路安全题", animal: "riddle", speech: "清完道路前，先回答一道安全小问题。" },
