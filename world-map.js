(function () {
  ...
  const WORLD_MAP = {
    starlight_mountain: {
      ...
      emoji: "⛰️",
      type: "mountain",
      description: "Mimi / 詹涞儿 和 Owlly / 姚头鹰 登上星光山，完成森林日记。黑熊怪也被大家理解，成为森林真正的守护者。",
    ...
    mist_swamp: {
      ...
      emoji: "🌫️",
      type: "swamp",
      description: "森林公路修好后，旧路仍被柔和的迷雾挡住。Mimi / 詹涞儿 和 Owlly / 姚头鹰 要跟随萤火虫、修好木桥，并帮助沼泽守护者恢复清醒。",
      ...
      next: "星光山",
      tasks: [
        { id: "ms_entrance", name: "迷雾沼泽入口", npc: "ruru", gameplay: "收集灯芯并点亮入口", reward: "进入萤火虫小径" },
        { id: "ms_firefly_trail", name: "萤火虫小径", npc: "owlly", gameplay: "收集发光孢子并找到木桥钥匙", reward: "进入沉睡木桥" },
        { id: "ms_bridge", name: "沉睡木桥", npc: "ruru", gameplay: "收集木桥板并帮助小青蛙", reward: "进入迷雾核心" },
        { id: "ms_core", name: "迷雾核心", npc: "owlly", gameplay: "收集光之孢子，帮助迷雾精灵", reward: "萤火虫灯笼" },
        { id: "ms_guardian", name: "沼泽泥浆怪", npc: "ruru", gameplay: "用光和知识帮助沼泽守护者", reward: "迷雾守护徽章" },
      ],
    },
    moonlight_lake: {
      name: "月光湖",
      emoji: "🌊",
      type: "lake",
      description: "月光湖边出现奇怪涟漪，Dodo 发现一页日记漂到了湖边。Mimi / 詹涞儿 和 Owlly / 姚头鹰 需要帮忙找回日记页并修好小木桥。",
    ...
    forest_school: {
      ...
      emoji: "🏫",
      type: "school",
      description: "Mimi / 詹涞儿 和 Owlly / 姚头鹰 在森林学校开始新一天的森林日记。Lily、Coco 和 Nono 都遇到了小麻烦，需要帮忙找作业本、送苹果、找铅笔。",
    ...
    apple_valley: {
      ...
      emoji: "🍎",
      type: "valley",
      description: "苹果谷丰收了，但 Coco 搬不动这么多苹果。Mimi / 詹涞儿 帮忙收集苹果、整理果篮，并把苹果送回森林学校。",
    ...
    riverside_dock: {
      ...
      emoji: "🌉",
      type: "dock",
      description: "河畔码头的桥坏了。Dodo 需要 Mimi / 詹涞儿 帮忙找船桨、修桥，才能继续前往湿地公园。",
      background: "assets/v2/v2-bg-pond.png",
    ...
    wetland_park: {
      ...
      emoji: "🦆",
      type: "wetland",
      description: "湿地公园出现异常迷雾。Dodo 和 Nono 发现迷雾似乎来自更北边的沼泽区域，Mimi / 詹涞儿 和 Owlly / 姚头鹰 准备前往调查。",
